    ...
    const cookiePopupHtml = '<div id="cookie-popup-container">' +
        '<div class="cookie-popup" style="display: none;">' +
            ...
            '<div class="cookie-popup-lower" style="display: none;">' +
                'To comply with the regulations governing cookies under the GDPR and the ePrivacy Directive we must receive your consent before you use any cookies except strictly necessary cookies.' +
            '</div>' +
        '</div>' +
    '</div>';
