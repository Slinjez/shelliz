  ...
  Highcharts.chart("container", {
    ...
    tooltip: {
      ...
      pointFormat:
        ...
        '<td style="padding:0"><b>{point.y:.1f} Policies</b></td></tr>',
      footerFormat: "</table>",
      shared: true,
      useHTML: true,
    },
    ...
    success: function (e) {
      if (e.status == "ok") {
        ...
        let chart_data = {
          x_axis: era,
          y_axis: y_axis,
          series_legend_text: "Policy Count",
          title_text: "Product Uptake",
          sub_title_text: "Shows market penentration for product per month",
